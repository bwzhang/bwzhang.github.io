...
// Check taken from http://stackoverflow.com/questions/11381673/detecting-a-mobile-browser
...
function handleHover(sectionName) {
...
sectionNames.forEach(function (sectionName) {
    ...
    if (window.mobileAndTabletCheck()) {
        button.on("click", function () { handleHover(sectionName); });
    } else {
        button.on("mouseover", function () { handleHover(sectionName); });
    }
});
